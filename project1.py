...
class MRWordFrequencyCount(MRJob):
    ...
    # TODO: populate stopwords on init?
    stopwords = {
        "a": 0,
        "b": 0,
        "c": 0,
    ...
    def reducer_calculate_chi(self):
        self.calculateChi()
        self.sortTokens()
        with open('C:/Users/gunne/OneDrive/Desktop/UNI/project1/output.txt', 'w') as file:
            for category in self.categories_chi:
    ...
    def logData(self, data):
        with open('C:/Users/gunne/OneDrive/Desktop/UNI/project1/log.txt', 'a') as file:
            for item in data:
                file.write(str(item) + "\n")
