            ...
            for token in self.categories_tokens[category]:
                ...
                for c in self.categories_tokens:
                    ...
                    if token in self.categories_tokens[c]:
                        add = self.categories_tokens[c][token]['A']
                        B += add
                ...
                self.categories_tokens[category][token]['B'] = B
                self.categories_tokens[category][token]['D'] = D
                self.categories_tokens[category][token]['C'] = self.totalDocuments[category] - self.categories_tokens[category][token]['A']
                T = self.categories_tokens[category][token]
                # R = N(AD - BC)^2 / (A+B)(A+C)(B+D)(C+D)
                self.categories_tokens[category][token]['R'] = \
